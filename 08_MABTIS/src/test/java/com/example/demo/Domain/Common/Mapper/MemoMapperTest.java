...
//        list.forEach(System.out::println);
        ...
        List<MemoDto> list = memoMapper.selectAllContains("writer","2"); // writer가 2를 포함한.
        list.forEach(System.out::println);
    }
    ...
    @Test
    public void t8(){
        MemoDto dto = new MemoDto(1L,"내용1 바뀜", "내다", LocalDateTime.now(),null);
...
//        MemoDto dto = new MemoDto(2000L,"내용1","작성자1", LocalDateTime.now(), null);
    ...
    public void t13(){
        ...
        param.put("type","text");
        param.put("keyword","1");
        List< Map<String,Object> > list = memoMapper.slectAllIfXMl(param);
